...
const SpecialityMenu = () => {
  return (
    <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-gray-800'>
      <h1 className='text-3xl font-medium'>Search By Expertise</h1>
      <p className='sm:w-1/3 text-center text-sm'>Easily explore our curated list of trusted doctors and book your appointments with convenience.</p>
