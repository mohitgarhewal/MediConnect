  ...
  return userData && (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] mt-3 text-neutral-700 gap-y-2.5">
      ...
      <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
            ...
            {
              isEdit
               ? <input className="bg-gray-100 max-w-28" value={userData.dob} type="date" onChange={(e)=> setUserData(prev=>({...prev, dob: e.target.value}))} />
